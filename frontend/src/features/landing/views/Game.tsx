      ...
      <div className="game-container">
         <section id="Remembrance" className="fade-in">
            <div className="game-content">
               <img src="/landing-page-img/Remembrance.png" alt="Remembrance Image" />
         ...
         <section id="Speak-to-me" className="fade-in-top">
            <div className="game-content">
               <img src="/landing-page-img/SpeaktoMe.jpg" alt="Speak to Me Game Image" />
               <div className="game-text">
                  ...
                  <p>
                     ...
                     <br></br>
                     It’s where masks drop, walls fall, and truth takes the mic.<br></br>
                     You’ll laugh, you’ll think, you’ll feel. <br></br> Cause this is
                     where <em> real </em> talk lives.<br></br> For those who feel too
                     much, say too little, or hold it all in,<br></br>
                     <em>Speak to Me</em> cracks open the silence. <br></br>It’s bold,
                     it’s raw, it’s a space to be seen, <br></br>To say what’s real and
                     feel what you mean. <br></br>In a world that often asks us to hide,
                     <em> Speak to Me </em> dares us to be seen.
                  </p>
               </div>
            </div>
         </section>
         ...
         <section id="Keep-It-Real" className="fade-in">
            <div className="game-content">
               <img src="/landing-page-img/KeepItReal.png" alt="Keep it Real Logo" />
               <div className="game-text">
                  ...
                  <p>
                     ...
                     truths, and enlightens minds—without ever feeling heavy. <br></br>
                     This is the space where vulnerability feels empowering, where honesty
                     builds community, and where healing happens through play. Whether
                     you're chilling with friends, building a stronger campus org, or just
                     looking for something real—this game is for you. <br></br>
         ...
         <section id="Home-is-the-Heart" className="fade-in">
            <div className="game-content">
               <img src="/landing-page-img/HomeIsTheHeart.png" alt="Home is the Heart" />
               <div className="game-text">
                  ...
                  <p>
                     ...
                     their emotions, and dream about the future together. In a fast-paced,
                     tech- driven world, this game helps families slow down, listen, and
                     reconnect—building understanding, healing divides, and nurturing the
                     deep bonds that make a house truly a home.
                  </p>
               </div>
            </div>
         </section>
         ...
         <section id="Call-It-Out" className="fade-in">
            <div className="game-content">
               <img src="/landing-page-img/CallitOut.png" alt="Call It Out Image" />
               <div className="game-text">
                  ...
                  <p>
                     ...
                     strength and bystanders into changemakers. Call It Out dares young
                     people to speak up, stand strong, and to build braver, kinder school
                     communities.
                  </p>
               </div>
            </div>
