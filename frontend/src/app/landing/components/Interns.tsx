...
const interns: Intern[] = [
   ...
   },
   {
      ...
      extra1: ' "I am excited about this project because the mission resonates with me, and I am honored to work on a project that\'ll help build bridges between people."',
               ...
               <div className="interns-row">
                  {groupedInterns[section].map((intern) => (
                     <div key={intern.id} className="intern-card">
                        <Image src={intern.image} alt={intern.name} width={400} height={300} className="intern-image" onClick={() => handleImageClick(intern)} />
                        <h1>{intern.name}</h1>
                        <h2>{intern.role}</h2>
                     </div>
                  ))}
